 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://test1.ws.study.com/", wsdlLocation = "file:/home/adventurer/project/j2ee/WebServiceStudy/ws_study01_client/hellows.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://test1.ws.study.com/", "HelloWSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/home/adventurer/project/j2ee/WebServiceStudy/ws_study01_client/hellows.wsdl");
    ...
    public HelloWSImpl getHelloWSImplPort() {
        return super.getPort(new QName("http://test1.ws.study.com/", "HelloWSImplPort"), HelloWSImpl.class);
    }
    ...
    public HelloWSImpl getHelloWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test1.ws.study.com/", "HelloWSImplPort"), HelloWSImpl.class, features);
    }
